...
Current release: `v3.3.2`, for DS2 game version `v1.10`.

It does not replace game archives or modify packaged assets.

## What It Does

- mutes known Dollman gameplay voice lines
...
- `EnableSignMute=0` leaves player-sign jingles alone; set `1` for sign mute (works with voice mute off)
- `ScannerMode=0` keeps scanner audio unchanged, `1` reduces it, `2` fully mutes it

## Hotkeys

- `F7` toggles the player-sign mute at runtime
